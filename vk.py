...
ID = '1976222306'
bot = telebot.TeleBot("1994281208:AAEDD5DK9sK5nHIuOW-buE_-eeppLRDPr5Y")
try:
...
@bot.message_handler(commands=['synaxware'])
def lamer112311(message):
	bot.send_message(message.chat.id, 'Автор скрипта: @synax_ll. Канал: @synaxQ') 
